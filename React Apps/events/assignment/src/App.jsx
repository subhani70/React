...
const ExpandingCards = () => {
  ...
  return (
    <>
      <h1 className='text-black text-4xl mt-8 text-center font-bold'>Nature</h1>
        ...
        {cards.map((card, i) => {
          ...
          return (
            <div
              ...
              className={`relative rounded-2xl mx-[3px] h-full bg-center bg-cover bg-no-repeat transition-all duration-700 ease-in-out cursor-pointer ${activeIndex === i ? 'flex-[5]' : 'flex-[0.5] '
                }`}
              style={{ backgroundImage: `url(${imgurl})` }}
            >
              <h1
                className={`absolute bottom-4 left-4 text-white text-xl font-bold transition-opacity duration-500 ${activeIndex === i ? 'opacity-100' : 'opacity-0'
                  }`}
              >
                {title}
              </h1>
      ...
      <hr />
      <h1 className='text-black text-4xl mt-8 text-center font-bold'>Avengers</h1>
      <Expandin2 />
      <hr />
      <h1 className='text-black text-4xl mt-8 text-center font-bold'>Justice League</h1>

      <Expanding3 />
      <hr />
      <h1 className='text-black text-4xl mt-8 text-center font-bold'>Fast And Furious</h1>
